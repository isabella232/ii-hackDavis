                    ...
                    <Grid container spacing={0} justify='center'>
                        <Grid item sm={12} md={6} lg={6}>
                            <div className={classes.avatarSection}>
                                <Grid container spacing={0} justify='center'>
                                    <Grid item xs={4} sm={4}>
                                        <Chip name={"Alejandra Matias Ramos"} index={0} click={this.changeBio}
                                            avatar={alejandra} />
                                    </Grid>

                                    <Grid item xs={4} sm={4}>
                                        <Chip name={"Damaso Calmo"} index={1} click={this.changeBio}
                                            avatar={damaso} />
                                    </Grid>

                                    <Grid item xs={4} sm={4}>
                                        <Chip name={"Leonor Mendoza"} index={2} click={this.changeBio}
                                            avatar={leonor} />
                                    </Grid>

                                    <Grid item xs={4} sm={4}>
                                        <Chip name={"Linda Sanchez Hernandez"} index={3} click={this.changeBio}
                                            avatar={linda} />
                                    </Grid>

                                    <Grid item xs={4} sm={4}>
                                        <Chip name={"Luis M. Pablo"} index={4} click={this.changeBio}
                                            avatar={luis} />
                                    </Grid>
                                    ...
                                    <Grid item xs={4} sm={4}>
                                        <Chip name={"Rocio Hernandez Cruz"} index={6} click={this.changeBio}
                                            avatar={rocio} />
                                    </Grid>
